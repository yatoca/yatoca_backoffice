...
const TopicsTable: React.FC<Props> = ({
    ...
    return (
        <div className="topics-card">
            ...
            <div className="topics-table" role="table" aria-label="Predefined Topics">
                {/* Header */}
                <div className="tr-topics th" role="row">
                    ...
                    <div className="td name">Topic Name</div>
                ...
                {loading ? (
                    ...
                    rows.map((r) => {
                        ...
                        return (
                            <div key={r.id} className="tr-topics" role="row">
                                {/* <div className="td checkbox">
                                    <input
                                        type="checkbox"
                                ...
                                <div className="td name">{sentence_case(r.name)}</div>

                                <div className="td desc">{r.description}</div>

                                <div className="td keywords">{r.keywords.map((k) => <span className="topic-keyword" key={k.keyword}>{sentence_case(k.keyword)}</span>)}</div>
