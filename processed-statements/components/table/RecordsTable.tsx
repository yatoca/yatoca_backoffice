...
type Props = {
    rows: ProcessedStatement[];                 // current page data
...
const RecordsTable: React.FC<Props> = ({
    ...
    return (
        <div className="records-card">
            ...
            <div className="records-table" role="table" aria-label="Unprocessed Records">
                {/* Header */}
                <div className="tr-processed th" role="row">
                    ...
                    <div className="td desc">Tema</div>
                ...
                {loading ? (
                    ...
                    rows.map((r) => {
                        ...
                        return (
                            <div key={r.id} className="tr-processed" role="row">
                                {/* <div className="td checkbox">
                                    <input
                                        type="checkbox"
                                ...
                                <div className="td suggested-topic">{r.topic_name}</div>
